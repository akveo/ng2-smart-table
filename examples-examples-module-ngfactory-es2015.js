...
class AdvancedExamplesCustomEditorComponent {
    constructor() {
        this.data = [
            {
                id: 1,
...
class AdvancedExamplesTypesComponent {
    constructor() {
        this.data = [
            {
                id: 1,
...
/* harmony import */ var ng2_smart_table__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ng2-smart-table */ "../../dist/ng2-smart-table/fesm2015/ng2-smart-table.js");
/**
 * @fileoverview This file was generated by the Angular template compiler. Do not edit.
 *
 * @suppress {suspiciousCode,uselessCode,missingProperties,missingOverride,checkTypes}
...
class BasicExampleButtonViewComponent {
    constructor() {
        this.settings = {
            columns: {
                id: {
...
class BasicExampleCustomActionsComponent {
    constructor() {
        this.settings = {
            actions: {
                custom: [
...
class CustomViewEditExamplesComponent {
    constructor() {
        this.snippets = {
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "../../node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var ng2_smart_table__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ng2-smart-table */ "../../dist/ng2-smart-table/fesm2015/ng2-smart-table.js");


class CustomEditorComponent extends ng2_smart_table__WEBPACK_IMPORTED_MODULE_1__["DefaultEditor"] {
    constructor() {
        super();
    }
    ngAfterViewInit() {
...
class CustomFilterComponent extends ng2_smart_table__WEBPACK_IMPORTED_MODULE_3__["DefaultFilter"] {
    constructor() {
        super();
...
/* harmony import */ var ng2_completer__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ng2-completer */ "../../node_modules/ng2-completer/esm2015/ng2-completer.js");
...
/* harmony import */ var ng2_smart_table__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ng2-smart-table */ "../../dist/ng2-smart-table/fesm2015/ng2-smart-table.js");
...
class AdvancedExampleFiltersComponent {
    constructor() {
        this.data = [
            {
                id: 4,
...
/* harmony import */ var ng2_smart_table__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ng2-smart-table */ "../../dist/ng2-smart-table/fesm2015/ng2-smart-table.js");

class BasicExampleSourceComponent {
    constructor() {
        this.settings = {
            columns: {
                id: {
...
class AdvancedExampleServerComponent {
    constructor(http) {
        this.settings = {
            columns: {
                id: {
...
class BasicExampleLoadComponent {
    constructor(service) {
...
class AdvancedExampleConfirmComponent {
    constructor() {
        this.settings = {
            delete: {
                confirmDelete: true,
...
class BasicExampleMultiSelectComponent {
    constructor() {
        this.settings = {
            selectMode: 'multi',
            columns: {
...
class VariousExamplesComponent {
}
